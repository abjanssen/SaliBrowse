export default class MyPlugin {
  ...
  install(pluginManager) {
    ...
    const citecontent = React.createElement(
      'div', 
      null, 
      React.createElement('h1', null, 'Citing SaliBrowse'),
      React.createElement('p', null, 'A reference for SaliBrowse will be available soon.'),
